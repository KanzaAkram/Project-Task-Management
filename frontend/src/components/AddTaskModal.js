                    ...
                    <div className="fixed inset-0 flex items-center justify-center p-4 w-screen h-screen">
                        ...
                        >
                            <Dialog.Panel className="rounded-md bg-white w-6/12">
                                ...
                                <Dialog.Title as='div' className={'bg-gray-200 shadow px-6 py-4 rounded-t-md sticky top-0'}>
                                ...
                                <form onSubmit={handleSubmit} className='gap-4 px-8 py-4 bg-gray-700'>
                                    <div className='mb-3'>
                                        <label htmlFor="title" className='block text-gray-300'>Title</label>
                                        <input value={title} onChange={(e) => setTitle(e.target.value)} type="text" className='border-2 border-gray-800 bg-transparent rounded-md w-full text-sm py-2 px-2.5 focus:border-indigo-500 focus:outline-offset-1 focus:outline-indigo-400' placeholder='Task title' />
                                    </div>
                                    <div className='mb-2'>
                                        <label htmlFor="Description" className='block text-gray-300'>Description</label>
                                        <textarea value={desc} onChange={(e) => setDesc(e.target.value)} className='border-2 border-gray-800 bg-transparent rounded-md w-full text-sm py-2 px-2.5 focus:border-indigo-500 focus:outline-offset-1 focus:outline-indigo-400' rows="6" placeholder='Task description'></textarea>
                                    </div>
