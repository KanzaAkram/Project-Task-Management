...
<div className="flex items-center justify-between ">
        <h1 className="text-2xl font-bold flex justify-start items-center space-x-2.5">
          <span>
            {title.slice(0, 25)}
            {title.length > 25 && "..."}
          </span>
      ...
      >
        <div className="sm:px-6 md:px-8  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {Object.entries(columns).map(([columnId, column], index) => {
            return (
              <div className="w-30vw" key={columnId}>
                <div className="pb-2.5 w-full flex justify-between">
                  <div className="inline-flex items-center space-x-2">
                    <h2 className="  font-medium text-sm uppercase leading-3">
                      {column.name}
                    </h2>
                    <span
                    ...
                    {(provided, snapshot) => {
                      return (
                        <div
                          ...
                          className={` pt-4 duration-75 transition-colors border-t-2 border-indigo-400 ${
                                ...
                                {(provided, snapshot) => {
                                  return (
                                    <div
                                      ...
                                      className={`select-none px-3.5 pt-3.5 pb-2.5 mb-2 border border-gray-200 rounded-lg shadow-sm  relative ${
