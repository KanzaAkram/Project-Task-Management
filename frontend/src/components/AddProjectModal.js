            ...
            >
              <Dialog.Panel className="rounded-md bg-white w-6/12">
                <Dialog.Title
                  as="div"
                  className={
                    "bg-gray-200 shadow px-6 py-4 rounded-t-md sticky top-0"
                  }
                >
                ...
                <form onSubmit={handleSubmit} className="gap-4 px-8 py-4 bg-gray-700">
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      type="text"
                      className="border-2 border-gray-800 bg-transparent rounded-md w-full text-sm py-2 px-2.5 focus:border-indigo-500 focus:outline-offset-1 focus:outline-indigo-400"
